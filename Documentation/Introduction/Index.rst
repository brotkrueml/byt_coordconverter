...
The extension converts spatial geo coordinates (latitude and longitude) from the degree notation to other output formats
with the help of a Fluid view helper.
